...
const Profile = () => {
  ...
  if (localStorage.getItem("userLogin")) {
    ...
    return <div>
        <h1 className="text-info">Hello mình là Trọng là học viên của cybersoft</h1>
        <span className="text-warning">Mình là học viên khóa bootcamp 26 tại CyberSoft</span>
    </div>;
  } else {
